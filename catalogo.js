const productos = [
  {
    ...
    medidas: [
      ...
      { titulo: "Diámetro", medidas: ["4.5mm", "5.5mm", "6.5mm", "7.5mm"] },
    ],
  ...
  },
  {
    ...
    descripcion:
      "XSPINOUS es un interespinoso que se utiliza en el tratamiento de la enfermedad degenerativa discal. Presenta un mecanismo de implantación por la vía lateral del espacio interespinoso preservando el ligamento supraespinoso.",
    medidas: { titulo: "Medidas", medidas: ["8mm", "10mm", "12mm", "14mm"] },
    imagenes: ["culito.png", "tuvieja.jpeg", "lastfoto.png"],
  },
  {
    categoria: "Columna",
